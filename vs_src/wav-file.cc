 ...
 *--------------------------------------------------------------------------------------
 */
long int WavFileReader::getNumSamples()
{
    return maxInSamples;
}
 ...
 *--------------------------------------------------------------------------------------
 */
double WavFileReader::getSampleRateHz()
{
    return fs_hz;
}
 ...
 *--------------------------------------------------------------------------------------
 */
int WavFileReader::ifMoreDataAvailable()
{
 ...
 *--------------------------------------------------------------------------------------
 */
double WavFileReader::readCurrentInput()
{
 ...
 *--------------------------------------------------------------------------------------
 */
int WavFileReader::openWavFile(char* fileName)
{
...
int WavFileReader::displayInformation(char* fName)
{
#if 1
   /*
    * print the data.
...
int WavFileReader::writeDataToFile()
{
    FILE* pFile;
    int n;
